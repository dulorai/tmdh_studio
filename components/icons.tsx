...
export const TumdahLogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg viewBox="0 0 100 90" xmlns="http://www.w3.org/2000/svg" {...props}>
        {/* Shadow */}
        <ellipse cx="50" cy="80" rx="35" ry="6" fill="currentColor" fillOpacity="0.3"/>
        {/* Main Cylinder body - using path for perspective */}
        <path d="M18 70 L28 30 L82 30 L72 70 Z" fill="#22c55e" stroke="currentColor" strokeWidth="5" strokeLinejoin="round"/>
        {/* End cap */}
        <ellipse cx="23" cy="50" rx="10" ry="20" fill="#22c55e" stroke="currentColor" strokeWidth="5"/>
        <ellipse cx="23" cy="50" rx="4" ry="9" fill="currentColor"/>
        {/* Stripes */}
        <path d="M43 30 L38 70" stroke="currentColor" strokeWidth="5"/>
        <path d="M63 30 L58 70" stroke="currentColor" strokeWidth="5"/>
        {/* Handle */}
        <path d="M35 28 C 40 8, 60 8, 65 28" stroke="currentColor" fill="none" strokeWidth="10" strokeLinecap="round"/>
    </svg>
);
...
export const FilmIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" {...props}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 20.25h12m-7.5-3.75v3.75m-3.75-3.75v3.75m-3.75-3.75V15m15 1.5V15M5.25 4.5h13.5c.621 0 1.125.504 1.125 1.125v13.5c0 .621-.504 1.125-1.125 1.125H5.25c-.621 0-1.125-.504-1.125-1.125V5.625c0-.621.504-1.125 1.125-1.125z" />
    </svg>
);